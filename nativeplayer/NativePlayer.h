...
// -----
#define CYPRESS_PLAYER_SPATIAL_AUDIO_MODE_NONE                              0
#define CYPRESS_PLAYER_SPATIAL_AUDIO_MODE_AMBIENT                           1
#define CYPRESS_PLAYER_SPATIAL_AUDIO_MODE_AMBIENT_GUESS_AMBISONIC_CONTENT   2
#define CYPRESS_PLAYER_SPATIAL_AUDIO_MODE_AMBIENT_AMBISONIC_1ST_CONTENT     3
...
CYPRESS_PLAYER_API void CypressPlayer_setSpatialAudioMode(CypressPlayer *player, int spatialAudioMode);

CYPRESS_PLAYER_API void CypressPlayer_enableSpatialAudio(CypressPlayer *player, bool enable);

CYPRESS_PLAYER_API void CypressPlayer_setSpatialAudioEntity(CypressPlayer *player, int64_t entityId);

CYPRESS_PLAYER_API void CypressPlayer_setSpatialAudioContainer(CypressPlayer *player, int64_t containerId);
...
typedef enum CypressPlayerSeekMode {
    CYPRESS_PLAYER_SEEK_MODE_EXACT,
    CYPRESS_PLAYER_SEEK_MODE_PREVIOUS,
    CYPRESS_PLAYER_SEEK_MODE_AUTO,
} CypressPlayerSeekMode;
