...
static sdl_amedia_status_t SDL_AMediaCodecDummy_set_surface(SDL_AMediaCodec* acodec, void *android_surface)
{
    return SDL_AMEDIA_OK;
}
...
SDL_AMediaCodec* SDL_AMediaCodecDummy_create()
{
    ...
    acodec->func_set_surface            = SDL_AMediaCodecDummy_set_surface;
