...
// NDK r21 declares struct AMediaCodecOnAsyncNotifyCallback but uses the
// typedef name in AMediaCodec_setAsyncNotifyCallback. Add the missing typedef
// before including NdkMediaCodec.h so C compilation works with server ndk-r21b.
