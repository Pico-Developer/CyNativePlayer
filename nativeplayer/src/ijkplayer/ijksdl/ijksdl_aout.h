...
struct SDL_Aout {
    ...
    double (*func_get_time_stamp)(SDL_Aout *aout);
    ...
    // PICO Spatial Audio
    uint32_t  (*func_set_spatial_audio_enable)(SDL_Aout *aout, bool enable);
    uint32_t   (*func_attach_to_entity)(SDL_Aout *aout, int64_t entityId);
    uint32_t   (*func_attach_to_container)(SDL_Aout *aout, int64_t audioBindId);
};
