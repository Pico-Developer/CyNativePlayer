...
#define J4A_FUNC_FAIL_TRACE()               do {CYLOGE("%s: failed\n", __func__);} while (0)
#define J4A_FUNC_FAIL_TRACE1(x__)           do {CYLOGE("%s: failed: %s\n", __func__, x__);} while (0)
#define J4A_FUNC_FAIL_TRACE2(x1__, x2__)    do {CYLOGE("%s: failed: %s %s\n", __func__, x1__, x2__);} while (0)
