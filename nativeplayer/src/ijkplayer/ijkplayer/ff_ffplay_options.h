...
static const AVOption ffp_context_options[] = {
    ...
    { "seek-at-start",                  "set offset of player should be seeked",
        OPTION_OFFSET(seek_at_start),       OPTION_INT64(AV_NOPTS_VALUE, INT64_MIN, INT64_MAX) },
    ...
    { "find_stream_info",               "read and decode the streams to fill missing information with heuristics" ,
        OPTION_OFFSET(find_stream_info),    OPTION_INT(0, 0, 1) },
    ...
    { "start-on-prepared",                  "automatically start playing on prepared",
        OPTION_OFFSET(start_on_prepared),   OPTION_INT(0, 0, 1) },
    ...
    { "mediacodec-all-videos",                  "MediaCodec: enable all videos",
        OPTION_OFFSET(mediacodec_all_videos),   OPTION_INT(1, 0, 1) },
    { "mediacodec-avc",                         "MediaCodec: enable H264",
        OPTION_OFFSET(mediacodec_avc),          OPTION_INT(1, 0, 1) },
    { "mediacodec-hevc",                        "MediaCodec: enable HEVC",
        OPTION_OFFSET(mediacodec_hevc),         OPTION_INT(1, 0, 1) },
    ...
    { "opensles",                           "OpenSL ES: enable",
        OPTION_OFFSET(opensles),            OPTION_INT(1, 0, 1) },
    ...
    { "codec-reuse-enable",         "keep codec when reset and reuse it",
        OPTION_OFFSET(codec_reuse_enable),     OPTION_INT(0, 0, 1) },
    { NULL }
};
