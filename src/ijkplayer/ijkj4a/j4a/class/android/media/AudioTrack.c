...
typedef struct J4AC_android_media_AudioTimestamp {
    jclass id;

    jmethodID constructor_AudioTimestamp;
    jfieldID field_framePosition;
    jfieldID field_nanoTime;
} J4AC_android_media_AudioTimestamp;
static J4AC_android_media_AudioTimestamp class_J4AC_android_media_AudioTimestamp;
...
jboolean J4AC_android_media_AudioTrack__getTimestamp(JNIEnv *env, jobject thiz, jobject audio_timestamp)
{
    return (*env)->CallBooleanMethod(env, thiz, class_J4AC_android_media_AudioTrack.method_getTimestamp, audio_timestamp);
}

jboolean J4AC_android_media_AudioTrack__getTimestamp__catchAll(JNIEnv *env, jobject thiz, jobject audio_timestamp)
{
    jboolean ret_value = J4AC_android_media_AudioTrack__getTimestamp(env, thiz, audio_timestamp);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return false;
    }
    return ret_value;
...
int J4A_loadClass__J4AC_android_media_AudioTrack(JNIEnv *env)
{
    ...
    CYLOGD("J4ALoader: OK: '%s' loaded\n", "android.media.AudioTrack");
    ret = 0;
fail:
    return ret;
}

jobject J4AC_android_media_AudioTimestamp__AudioTimestamp(JNIEnv *env)
{
    return (*env)->NewObject(env, class_J4AC_android_media_AudioTimestamp.id, class_J4AC_android_media_AudioTimestamp.constructor_AudioTimestamp);
}

jobject J4AC_android_media_AudioTimestamp__AudioTimestamp__catchAll(JNIEnv *env)
{
    jobject ret_object = J4AC_android_media_AudioTimestamp__AudioTimestamp(env);
    if (J4A_ExceptionCheck__catchAll(env) || !ret_object) {
        return NULL;
    }
...
jobject J4AC_android_media_AudioTimestamp__AudioTimestamp__asGlobalRef__catchAll(JNIEnv *env)
{
    jobject ret_object   = NULL;
    jobject local_object = J4AC_android_media_AudioTimestamp__AudioTimestamp__catchAll(env);
    if (J4A_ExceptionCheck__catchAll(env) || !local_object) {
        ret_object = NULL;
        goto fail;
    }
...
jlong J4AC_android_media_AudioTimestamp__framePosition(JNIEnv *env, jobject thiz)
{
    return (*env)->GetLongField(env, thiz, class_J4AC_android_media_AudioTimestamp.field_framePosition);
}

jlong J4AC_android_media_AudioTimestamp__framePosition__catchAll(JNIEnv *env, jobject thiz)
{
    jlong ret = J4AC_android_media_AudioTimestamp__framePosition(env, thiz);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
    return ret;
...
jlong J4AC_android_media_AudioTimestamp__nanoTime(JNIEnv *env, jobject thiz)
{
    return (*env)->GetLongField(env, thiz, class_J4AC_android_media_AudioTimestamp.field_nanoTime);
}

jlong J4AC_android_media_AudioTimestamp__nanoTime__catchAll(JNIEnv *env, jobject thiz)
{
    jlong ret = J4AC_android_media_AudioTimestamp__nanoTime(env, thiz);
    if (J4A_ExceptionCheck__catchAll(env)) {
        return 0;
    }
    return ret;
...
int J4A_loadClass__J4AC_android_media_AudioTimestamp(JNIEnv *env) {
    int         ret                   = -1;
    const char *J4A_UNUSED(name)      = NULL;
    const char *J4A_UNUSED(sign)      = NULL;
    jclass      J4A_UNUSED(class_id)  = NULL;
    ...
    if (class_J4AC_android_media_AudioTimestamp.id != NULL)
        return 0;

    sign = "android/media/AudioTimestamp";
    class_J4AC_android_media_AudioTimestamp.id = J4A_FindClass__asGlobalRef__catchAll(env, sign);
    if (class_J4AC_android_media_AudioTimestamp.id == NULL)
        goto J4A_loadClass__J4AC_android_media_AudioTimestamp_fail;

    class_id = class_J4AC_android_media_AudioTimestamp.id;
    name     = "<init>";
    sign     = "()V";
    class_J4AC_android_media_AudioTimestamp.constructor_AudioTimestamp = J4A_GetMethodID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTimestamp.constructor_AudioTimestamp == NULL)
        goto J4A_loadClass__J4AC_android_media_AudioTimestamp_fail;

    class_id = class_J4AC_android_media_AudioTimestamp.id;
    name     = "framePosition";
    sign     = "J";
    class_J4AC_android_media_AudioTimestamp.field_framePosition = J4A_GetFieldID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTimestamp.field_framePosition == NULL)
        goto J4A_loadClass__J4AC_android_media_AudioTimestamp_fail;

    class_id = class_J4AC_android_media_AudioTimestamp.id;
    name     = "nanoTime";
    sign     = "J";
    class_J4AC_android_media_AudioTimestamp.field_nanoTime = J4A_GetFieldID__catchAll(env, class_id, name, sign);
    if (class_J4AC_android_media_AudioTimestamp.field_nanoTime == NULL)
        goto J4A_loadClass__J4AC_android_media_AudioTimestamp_fail;

    CYLOGD("J4ALoader: OK: '%s' loaded\n", "android.media.AudioTimestamp");
    ret = 0;
J4A_loadClass__J4AC_android_media_AudioTimestamp_fail:
    return ret;
}
